...
export function iconPlay(): SVGSVGElement {
	return svg(["M8 5v14l11-7z"]);
}

/** Pause bars ❚❚ */
export function iconPause(): SVGSVGElement {
	return svg(["M6 19h4V5H6v14zm8-14v14h4V5h-4z"]);
}
...
export function iconSkipForward(): SVGSVGElement {
	return svg(["M5 18l10-6L5 6v12zm12-12v12h2V6h-2z"]);
}
...
export function iconExternalLink(): SVGSVGElement {
	return svg([
		...
		"M19 19H5V5h7V3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7h-2v7z",
	]);
}
