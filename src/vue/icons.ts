...
export const IconPlay = defineComponent({
	name: "IconPlay",
	render() {
		return h("svg", defaults, [h("path", { d: "M8 5v14l11-7z" })]);
	},
});

export const IconPause = defineComponent({
	name: "IconPause",
	render() {
...
export const IconVolumeHigh = defineComponent({
	name: "IconVolumeHigh",
	render() {
		return h("svg", defaults, [
			h("path", {
...
export const IconVolumeLow = defineComponent({
	name: "IconVolumeLow",
	render() {
		return h("svg", defaults, [
			h("path", {
...
export const IconVolumeMute = defineComponent({
	name: "IconVolumeMute",
	render() {
		return h("svg", defaults, [
			h("path", {
...
export const IconFullscreenEnter = defineComponent({
	name: "IconFullscreenEnter",
	render() {
		return h("svg", defaults, [
			h("path", {
...
export const IconFullscreenExit = defineComponent({
